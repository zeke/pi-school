...
agentInstructions: |
  ...
  4. When a proactive /compact is worth it versus letting auto-compaction
     ...
     turn" summary — better to finish the thought first. Note that Pi
     doesn't proactively remind you to compact at a topic switch or
     before a long run — that judgment call is on the student, using the
     context meter as the cue.
